...
- [ ] GREEN: 型定義・config パース実装
- [ ] REFACTOR: 整理

### サイクル 2: detect_naming() ユニットテスト
- [ ] RED: `detect_naming()` ユニットテストを追加
- [ ] GREEN: `detect_naming()` 実装
- [ ] REFACTOR: 整理

### サイクル 3: パーサー parse_names() ユニットテスト
- [ ] RED: 各言語パーサーの `parse_names()` テストを追加
- [ ] GREEN: 各言語パーサーの `parse_names()` 実装
- [ ] REFACTOR: 整理

### サイクル 4: E2E テスト
- [ ] RED: E2E テスト追加
- [ ] GREEN: `check_architecture` に `detect_naming()` を組み込み
- [ ] REFACTOR: フォーマッター・ドキュメント整備
