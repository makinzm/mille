...
Analyzes import statements in your source files to infer layer structure and dependencies, then generates `mille.toml`. You can pass a project directory as a positional argument. Defaults to the current directory (`.`) if omitted.
