...
mille's **naming convention check** lets you define forbidden keywords per layer, scanning file names, symbol names, variable names, and comments.
...
| `name_targets` | `["file", "symbol", "variable", "comment"]` | Which targets to check. Defaults to all |
...
By default, all 4 target types are checked. You can narrow the scope:
...
| Language | Symbols | Variables | Comments | File names |
|---|:---:|:---:|:---:|:---:|
| Rust | ✅ | ✅ | ✅ | ✅ |
